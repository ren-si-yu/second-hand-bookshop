            ...
            <nav class="navbar navbar-default" role="navigation" style="padding: 0 9%">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <%--<a href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=type&page=1">买书</a>--%>
                        ...
                        <li>
                            <form action="page_getBuyBookPage.action?typeOrName=type&page=1" method="get" class="bar6">
                ...
                <center>
                    <ul class="pagination pagination-lg">
                        <li <s:if test="!myPage.isHasPre||myPage.page<1">class="disabled" </s:if>><a
                                href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=<s:property value="typeOrName"/>&page=<s:property value="myPage.page-5"/>">&laquo;</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=<s:property value="typeOrName"/>&page=<s:property value="myPage.page"/>">
                                <s:property value="myPage.page"/></a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=<s:property value="typeOrName"/>&page=<s:property value="myPage.page+1"/>">
                                <s:property value="myPage.page+1"/></a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=<s:property value="typeOrName"/>&page=<s:property value="myPage.page+2"/>">
                                <s:property value="myPage.page+2"/></a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=<s:property value="typeOrName"/>&page=<s:property value="myPage.page+3"/>">
                                <s:property value="myPage.page+3"/></a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=<s:property value="typeOrName"/>&page=<s:property value="myPage.page+4"/>">
                                <s:property value="myPage.page+4"/></a></li>
                        <li <s:if test="!myPage.isHasNext||myPage.page+5>myPage.totalPage">class="disabled" </s:if>><a
                                href="${pageContext.request.contextPath}/page_getBuyBookPage.action?typeOrName=<s:property value="typeOrName"/>&page=<s:property value="myPage.page+9"/>">&raquo;</a>
                        </li>
                    </ul>
                </center>
            </div>
...
<div class="rightdown" style="width: 50px;height: 300px;position: fixed;right: 0px;bottom: 200px">
    ...
    <a href="BuyCar.jsp" class="list-group-item"><span class="glyphicon glyphicon-shopping-cart"></span>查看购物车</a>
    <a href="#" class="list-group-item active"><span class="glyphicon glyphicon-user"></span> 联系客服</a>
</div>
