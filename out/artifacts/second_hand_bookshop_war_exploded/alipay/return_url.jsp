...
<%
    ...
    if (signVerified) {
        ...
        response.sendRedirect(request.getContextPath() + "/buy_addOrder.action");
        /*request.getRequestDispatcher("buy_addOrder.action?out_trade_no=" + out_trade_no + "&trade_no=" + trade_no).forward(request, response);*/
        return;
    } else {
        out.println("验签失败");
    }
