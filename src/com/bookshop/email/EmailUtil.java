...
//            fileInputStream = new FileInputStream(file);
    ...
    public void sendMessage(String email, String key) throws Exception {
        ...
        msg.setContent("<html>\n" +
                ...
                "                                                                       class=\"font_darkblue\">" + email + "</span></p>\n" +
                "                        <br>\n" +
                "                        <p><b>您的验证码为：</b><br>\n" +
                "                        <center>\n" +
                "                    <span class=\"font_lightblue\">\n" +
                "                        <span id=\"yzm\" data=\"$(captcha)\" onclick=\"return false;\" t=\"7\"\n" +
                "                              style=\"font-size: 30px;border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;\">" + key + "</span>\n" +
                "                    </span><br>\n" +
                "                        </center>\n" +
                "                        <span class=\"font_gray\">(请输入该验证码完成注册，验证码30分钟内有效！)</span><br><br>\n" +
                "                        </p>\n" +
                "                        <div class=\"line\"><br><br>如果您并未请求此验证码，则可能是他人正在使用您的邮箱：" + email + "。<b>请勿将此验证码转发给或提供给任何人。</b>\n" +
                "                        </div>\n" +
                "                    </div>\n" +
                "                </div>\n" +
                "                <b class=\"xbottom\"><b class=\"xb4\"></b><b class=\"xb3\"></b><b class=\"xb2\"></b><b class=\"xb1\"></b></b>\n" +
                "                <p class=\"foot\"> <br><span data=\"800-820-5100\" onclick=\"return false;\" t=\"7\"\n" +
                "                                                             style=\"border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;\">任思雨慕玉红小组敬上\n" +
                "</span></p>\n" +
                "            </div>\n" +
                "        </center>\n" +
                "    </div>\n" +
